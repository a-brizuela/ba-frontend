  ...
  return (
    <div>
      {selectedTraveler && selectedTraveler.firstName && (
        <div style={{ height: "100%", backgroundColor: "#F7F6FA", borderRadius: "12px", padding: "0 1rem"}}>
          <p>
            Mobile example, it consumes a different endpoint without remarks
          </p>
          <h2>
...
export default TripPnrMobileExample;
